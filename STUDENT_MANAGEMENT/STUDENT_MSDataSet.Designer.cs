...
namespace STUDENT_MS.STUDENT_MSDataSetTableAdapters {
...
SELECT ID, Name, Gender, Dob, Major, FID, StudyDate FROM Student WHERE (ID = @ID)";
        ...
        public virtual int Fill(STUDENT_MSDataSet.StudentDataTable dataTable) {
        ...
        public virtual STUDENT_MSDataSet.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            STUDENT_MSDataSet.StudentDataTable dataTable = new STUDENT_MSDataSet.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(STUDENT_MSDataSet.StudentDataTable dataTable) {
